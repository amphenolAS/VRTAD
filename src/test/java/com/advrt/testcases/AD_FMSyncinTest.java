 ...
 /*                    
		...
		Description              :This Test Suite TC's related to FM Sync In operations
...
public class AD_FMSyncinTest extends BaseClass{
	...
	private void PreSetUp() throws Exception {
		...
		extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/ER"+"AD_FMSyncinTestReg(1.6.14)"+".html",true);
