...
public class AD_FM_Syncout_Audit_AdminTest extends BaseClass{
	...
	private void PreSetUp() throws Exception {
		...
		extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/ER"+"_AD_FM_Syncout_Audit_AdminTest(1.6.14)"+".html",true);
	...
	public void AD_SYNCOUT_002() throws InterruptedException, AWTException, IOException {
		...
		FM_SyncOutPage = FileManagementPage.ClickSyncOutBtn_SyncOutPage(prop.getProperty("Group1UserId"),prop.getProperty("Group1Pwd"),"comm");
