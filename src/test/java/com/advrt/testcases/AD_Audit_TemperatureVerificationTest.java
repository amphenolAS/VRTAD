...
import com.advrt.pages.QualificationPage;
...
public class AD_Audit_TemperatureVerificationTest extends BaseClass {
	...
	// AD_Ver_Audit _001 Verify the Audit trail entry when initated verification for
	// Temperature Loggers from Equipment screen
	...
	// AD_Ver_Audit _002 Verify the Audit trail entry when saved the verification
	// setup for Temperature Loggers
	...
	// AD_Ver_Audit _003 Verify the Audit trail entry when deleted the verification
	// setup for Temperature Loggers
	...
	// AD_Ver_Audit _004 Verify the Audit trail entry when printed the verification
	// setup report for Temperature Loggers
	...
	// AD_Ver_Audit _005 Verify the Audit trail entry when aborted the programming
	...
	// AD_Ver_Audit _006 Verify the Audit trail entry when started the verification
	// study for Temperature Loggers
	...
	// AD_Ver_Audit _007 Verify the Audit trail entry when aborted the verification
	// study for Temperature Loggers
	...
	/*
	 * 
	 * //AD_Ver_Audit _009 Verify the Audit trail entry when initated verification
	 * for Humidity Loggers-Temperature Sensors from Equipment screen
	 * 
	 ...
	 * )
	 * 
	 * public void AD_Ver_Audit_009() throws InterruptedException, AWTException,
	 * IOException { extentTest = extent
	 ...
	 * 
	 * EquipmentHubPage =MainHubPage.ClickEquipmentTile();
	 * EquipmentHubPage.IntiQual_Btn(); EquipmentHubPage.clickon_Humidityradiobtn();
	 * EquipmentHubPage.clickon_HumidityTempbtn();
	 * setup_verificationpage=EquipmentHubPage.loggerokbutton(); Thread.sleep(500);
	 * EquipmentHubPage=setup_verificationpage.ClickBackBtn();
	 * MainHubPage=EquipmentHubPage.ClickBackBtn();
	 * AuditPage=MainHubPage.ClickAuditTitle();
	 * 
	 ...
	 * 
	 * 
	 * //AD_Ver_Audit _010 Verify the Audit trail entry when saved the verification
	 * setup for Humidity Loggers-Temperature Sensors
	 * 
	 * @Test(priority=8,description =
	 * "AD_Ver_Audit _010 Verify the Audit trail entry  when started the verification setup for Humidity Loggers-Temperature Sensors"
	 * )
	 * 
	 * public void AD_Ver_Audit_010() throws InterruptedException, AWTException,
	 * IOException { extentTest = extent
	 ...
	 * 
	 * 
	 * // AD_Ver_Audit _011 Verify the Audit trail entry when deleted the
	 * verification setup for Humidity Loggers-Temperature Sensors
	 * 
	 ...
	 * )
	 * 
	 * public void AD_Ver_Audit_011() throws InterruptedException, AWTException,
	 * IOException { extentTest = extent
	 ...
	 * 
	 * 
	 * //AD_Ver_Audit _012 Verify the Audit trail entry when printed the
	 * verification setup report for Humidity Loggers-Temperature Sensors
	 * 
	 ...
	 * )
	 * 
	 * public void AD_Ver_Audit_012() throws InterruptedException, AWTException,
	 * IOException { extentTest = extent
	 ...
	 * 
	 * 
	 * //AD_Ver_Audit _013 Verify the Audit trail entry when started the
	 * verification study for Humidity Loggers-Temperature Sensors
	 * 
	 * @Test(priority=11,description =
	 * "AD_Ver_Audit _013 Verify the Audit trail entry  when started the verification study for Humidity Loggers-Temperature Sensor"
	 * )
	 * 
	 * public void AD_Ver_Audit_013() throws InterruptedException, AWTException,
	 * IOException { extentTest = extent
	 ...
	 * setup_verificationpage.EntersetupName("T_Setup6");
	 * SelectBaseStationPage=setup_verificationpage.ClicknextBtn();
	 * TimeUnit.SECONDS.sleep(30); SelectBaseStationPage.Click_DiscoverBS();
	 * TimeUnit.SECONDS.sleep(30); String BSIP="10.17.18.114";
	 * SelectBaseStationPage.Select_BSListbox("Ethernet IP-- " + BSIP);
	 * SelectLoggersPage=SelectBaseStationPage.Click_ConnectBtn(); //TimeUnit.
	 * MINUTES. sleep(2);//need to wakeup/connect logger to bsestation
	 * SelectLoggersPage.Select_LogListbox("TW74"); Thread.sleep(2000);
	 * SensorsInformationPage=SelectLoggersPage.clickNext_SensorinfoBtn();
	 * TimeUnit.SECONDS.sleep(30); ProgramLoggersPage=SensorsInformationPage.
	 ...
	 * sa.assertAll(); }
	 * 
	 * //AD_Ver_Audit _014 Verify the Audit trail entry when aborted the
	 * verification study for Humidity Loggers-Temperature Sensors
	 * 
	 ...
	 * ) public void AD_Ver_Audit_014() throws InterruptedException, AWTException,
	 * IOException { extentTest = extent
	...
	// AD_Ver_Audit _016 Verify the Audit trail entry when initated verification for
	// Humidity Loggers-Humidity Sensors from Equipment screen
	...
	// AD_Ver_Audit _017 Verify the Audit trail entry when started the verification
	// setup for Humidity Loggers-Humidity Sensors
	...
	// //AD_Ver_Audit _018 Verify the Audit trail entry when deleted the
	// verification setup for Humidity Loggers-Humidity Sensors
	...
	// AD_Ver_Audit _019 Verify the Audit trail entry when printed the verification
	// setup report for Humidity Loggers-Humidity Sensors
	...
	// AD_Ver_Audit _020 Verify the Audit trail entry when started the verification
	// study for Humidity Loggers-Humidity Sensors
	...
	// AD_Ver_Audit _021 Verify the Audit trail entry when aborted the verification
	// study for Humidity Loggers-Humidity Sensors
