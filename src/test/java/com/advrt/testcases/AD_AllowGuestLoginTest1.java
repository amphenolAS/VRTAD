...
public class AD_AllowGuestLoginTest1 extends BaseClass {
	...
	// ALG05-Verify if System Administrator able to activate the Allow Guest login
	// as supervisor
	@Test(groups = { "Sanity",
	...
	// ALG06-Verify if System Administrator able to activate the Allow Guest login
	// as Operator
	...
	// ALG07-Verify if System Administrator able to activate the Allow Guest login
	...
	// ALG04-Verify if User type is enabled once Allow Guest Login Check box is
	// checked
