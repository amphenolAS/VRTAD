 ...
 /*                    
		...
		Description              :This Test Suite TC's related to Audit trail entry while performing archive operation with Operator user
...
public class AD_FM_Archive_OprAuditTest extends BaseClass{
	
	public AD_FM_Archive_OprAuditTest() throws IOException {
		super();
		// TODO Auto-generated constructor stub
	}

	//com.advrt.testcases.AD_FM_Archive_OprAuditTest#AD_Archive_001
	...
	@AfterClass
		public void endReport() throws InterruptedException {
			extent.flush();
			extent.close();
			System.out.println("AD_FM_Archive_OprAuditTest  test completed");
			Thread.sleep(500);
	}
	...
	*********/
	...
	public void AD_Archive_023() throws InterruptedException, AWTException, IOException {
		extentTest = extent
				.startTest("AD_Archive _023 Verify the Audit trail entry  while login with the  Active Directory Operator  User");
	...
	@Test(priority=1,description = "AD_Archive _024 Verify the Audit trail entry while peforming Archive  operation with the  Active Directory Operator  User")

	public void AD_Archive_024() throws InterruptedException, AWTException, IOException {
		extentTest = extent
				.startTest("AD_Archive _024 Verify the Audit trail entry while peforming Archive  operation with the  Active Directory Operator  User");
...
try {
	...
	e.printStackTrace();
		...
		//AD_Archive _026 Verify the no Audit trail entry is recoreded related to Equipments when peforming Archive  operation when Equipments check box is unckecked with the  Active Directory Operator  User
		
		
		@Test(priority=2,description = "AD_Archive _026 Verify the no Audit trail entry is recoreded related to Equipments when peforming Archive  operation when Equipments check box is unckecked with the  Active Directory Operator  User")

		public void AD_Archive_026() throws InterruptedException, AWTException, IOException {
			extentTest = extent
					.startTest("AD_Archive _026 Verify the no Audit trail entry is recoreded related to Equipments when peforming Archive  operation when Equipments check box is unckecked with the  Active Directory Operator  User");
...
try {
	...
	e.printStackTrace();
		...
		//AD_Archive _029 Verify the  Audit trail entry is recoreded related to Equipments  when peforming Archive  operation when Equipments check box is ckecked with the  Active Directory Operator  User
		
		
		@Test(priority=3,description = "AD_Archive _029 Verify the  Audit trail entry is recoreded related to Equipments  when peforming Archive  operation when Equipments check box is ckecked with the  Active Directory Operator  User")

		public void AD_Archive_029() throws InterruptedException, AWTException, IOException {
			extentTest = extent
					.startTest("AD_Archive _029 Verify the  Audit trail entry is recoreded related to Equipments  when peforming Archive  operation when Equipments check box is ckecked with the  Active Directory Operator  User");
		...
		//AD_Archive _031 Verify the Audit trail entry while peforming Archive  operation by selecting only 1 asset  with the  Active Directory Operator  User
		
		@Test(priority=4,description = "AD_Archive _031 Verify the Audit trail entry while peforming Archive  operation by selecting only 1 asset  with the  Active Directory Operator  User")

		public void AD_Archive_031() throws InterruptedException, AWTException, IOException {
			extentTest = extent
					.startTest("AD_Archive _031 Verify the Audit trail entry while peforming Archive  operation by selecting only 1 asset  with the  Active Directory Operator  User");
		...
		//AD_Archive _032 Verify the Audit trail entry while peforming Archive  operation by selecting 200 asset  with the  Active Directory Operator  User

		@Test(priority=5,description = "AD_Archive _032 Verify the Audit trail entry while peforming Archive  operation by selecting 200 asset  with the  Active Directory Operator  User")

		public void AD_Archive_032() throws InterruptedException, AWTException, IOException {
			extentTest = extent
					.startTest("AD_Archive _032 Verify the Audit trail entry while peforming Archive  operation by selecting 200 asset  with the  Active Directory Operator  User");
...
sa.assertAll();
		...
		//AD_Archive _033 Verify the Audit trail entry while peforming Archive  operation by Select All button  with the  Active Directory Operator  User
		
		@Test(priority=6,description = "AD_Archive _033 Verify the Audit trail entry while peforming Archive  operation by Select All button  with the  Active Directory Operator  User")

		public void AD_Archive_033() throws InterruptedException, AWTException, IOException {
			extentTest = extent
					.startTest("AD_Archive _033 Verify the Audit trail entry while peforming Archive  operation by Select All button  with the  Active Directory Operator  User");
		...
		//AD_Archive _034 Verify the Audit trail entry while peforming Archive  operation by not selecting any Asset with the  Active Directory Operator  User
}