...
public class AD_PolicyTest extends BaseClass{
	...
	private void PreSetUp() throws Exception {
		...
		extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/ER"+"_ADpolicyTestReg(1.6.14)"+".html",true);
...
public void AD_Policies02() throws InterruptedException, IOException {
extentTest = extent
