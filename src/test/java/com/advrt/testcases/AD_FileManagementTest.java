...
public class AD_FileManagementTest extends BaseClass{
	...
	private void PreSetUp() throws Exception {
		...
		extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/ER"+"AD_FileManagementTestReg(1.6.14)"+".html",true);
	...
	public void FM02() throws InterruptedException, IOException, AWTException {
		...
		String a="\\";
		String ExpectMSG = "Report - \""+studyFileName+"\" , \"Copy to drive\" operation was performed by User Id : \""+"Ajay2"+"\", User Name : \""+"Ajay Mashal"+"\" to \""+foldrpath+a+"A=(MM)=(oidfglskdhlsdlglhsdl)=1=15-Nov-2023 10-50-46=.pdf"+"\"";
...
Thread.sleep(500);
		...
		String Actionmsg = AuditPage.get_auditEvent_text();
		String a="\\";
		String ExpectMSG = "Report - \""+studyFileName+"\" , \"Copy to drive\" operation was performed by User Id : \""+"Ajay2"+"\", User Name : \""+"Ajay Mashal"+"\" to \""+foldrpath+a+"G=(case-35)=(asdfghjkl)=1=17-Nov-2023 12-00-22=.pdf"+"\"";
