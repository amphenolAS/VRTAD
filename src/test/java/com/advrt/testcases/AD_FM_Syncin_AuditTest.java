/*                    
		...
		Description              :This Test Suite TC's related to Audit trail entry while performing Syncin operation 
...
public class AD_FM_Syncin_AuditTest extends BaseClass{
	
	public AD_FM_Syncin_AuditTest() throws IOException {
		super();
