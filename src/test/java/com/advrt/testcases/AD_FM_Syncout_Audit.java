...
public class AD_FM_Syncout_Audit extends BaseClass{
	
	public AD_FM_Syncout_Audit() throws IOException {
		super();
	...
	private void PreSetUp() throws IOException, InterruptedException, AWTException {
		...
		extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/ER"+"_AD_FM_Syncout_AuditTest"+".html",true);
	...
	@AfterClass
		public void endReport() throws InterruptedException {
			extent.flush();
			extent.close();
			System.out.println("AD_FM_Syncout_Audit  test completed");
			Thread.sleep(500);
	}
	...
	*********/
	...
	//Conduct a Syncout operation
			...
			FM_SyncOutPage = FileManagementPage.ClickSyncOutBtn_SyncOutPage("ruchika1","Amphenol@123","comm");
	...
	public void AD_SYNCOUT_004() throws InterruptedException, AWTException, IOException {
		...
		System.out.println("This Tc has already covered");
