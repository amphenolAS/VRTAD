...
public class AD_FileManagementTest2 extends BaseClass{

	public AD_FileManagementTest2() throws IOException {
		super();
	...
	public void endReport() throws InterruptedException {
		extent.flush();
		extent.close();
		System.out.println("AD_FileManagementTest2 test completed");
		Thread.sleep(500);
	}
	...
	//FM06-Verify the on-click functionality of Delete icon for Audit report under Reports tile-Audit sub tab


	@Test(priority=0,groups = { "Sanity",
	"Regression" }, description = "FM06-Verify the on-click functionality of Delete icon for Audit report under Reports tile-Audit sub tab")

	public void FM06() throws InterruptedException, IOException, AWTException
	{
		extentTest = extent
				.startTest("FM06-Verify the on-click functionality of Delete icon for Audit report under Reports tile-Audit sub tab");
		SoftAssert sa = new SoftAssert();

		assetDetailsPage = assetHubPage.click_assetTile("1304");
	...
	//FM11-Verify the Audit trial record exists for Deletion of a Audit report
	
	@Test(priority=0,groups = { "Sanity",
	"Regression" }, description = "FM11-Verify the Audit trial record exists for Deletion of a Audit report")

	public void FM011() throws InterruptedException, IOException, AWTException
	{
		extentTest = extent
				.startTest("FM11-Verify the Audit trial record exists for Deletion of a Audit report");
		SoftAssert sa = new SoftAssert();

		System.out.println("This TC has been covered in FM06");
	...
	//FM07-Verify the on-click functionality of Delete icon for Graph report under Reports tile-Graph sub tab
	
	@Test(priority=0,groups = { "Sanity",
	"Regression" }, description = "FM07-Verify the on-click functionality of Delete icon for Graph report under Reports tile-Graph sub tab")

	public void FM07() throws InterruptedException, IOException, AWTException
	{
		extentTest = extent
				.startTest("FM07-Verify the on-click functionality of Delete icon for Graph report under Reports tile-Graph sub tab");
		SoftAssert sa = new SoftAssert();
	...
	//FM10-Verify the Audit trial record exists for Deletion of a Graph report
	@Test(priority=0,groups = { "Sanity",
	"Regression" }, description = "FM10-Verify the Audit trial record exists for Deletion of a Graph report")

	public void FM010() throws InterruptedException, IOException, AWTException
	{
		extentTest = extent
				.startTest("FM10-Verify the Audit trial record exists for Deletion of a Graph report");
		SoftAssert sa = new SoftAssert();

		System.out.println("This TC has been covered in FM07");
