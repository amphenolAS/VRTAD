...
public class AD_Audit_Humidity_TempVerificationTest extends BaseClass {

	public AD_Audit_Humidity_TempVerificationTest() throws IOException {
		super();
	...
	public void endReport() throws InterruptedException {
		extent.flush();
		extent.close();
		System.out.println("AD_HumidityAuditVerificationTest  test completed");
		Thread.sleep(500);
	}
	...
	// AD_Ver_Audit _009 Verify the Audit trail entry when initated verification for
	// Humidity Loggers-Temperature Sensors from Equipment screen
	...
	public void AD_Ver_Audit_010() throws InterruptedException, AWTException, IOException {
		...
		setup_verificationpage = EquipmentHubPage.loggerokbutton();
		Thread.sleep(500);
		setup_verificationpage.ChangesetpointSetup("70.0");
		UserLoginPopup_UserCommentTextBox2("kaverib", "Amphenol@123", "committed");
		Thread.sleep(500);
	...
	// AD_Ver_Audit _011 Verify the Audit trail entry when deleted the verification
	// setup for Humidity Loggers-Temperature Sensors
	...
	public void AD_Ver_Audit_011() throws InterruptedException, AWTException, IOException {
		...
		setup_verificationpage = EquipmentHubPage.loggerokbutton();
		Thread.sleep(500);
		setup_verificationpage.ChangesetpointSetup("71.0");
	...
	// AD_Ver_Audit _012 Verify the Audit trail entry when printed the verification
	// setup report for Humidity Loggers-Temperature Sensors
	...
	// AD_Ver_Audit _013 Verify the Audit trail entry when started the verification
	// study for Humidity Loggers-Temperature Sensors
	...
	// AD_Ver_Audit _014 Verify the Audit trail entry when aborted the verification
	// study for Humidity Loggers-Temperature Sensors
