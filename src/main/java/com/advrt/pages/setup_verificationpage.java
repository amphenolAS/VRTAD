...
public class setup_verificationpage extends BaseClass {

	TestUtilities tu = new TestUtilities();
	// Define Setup page element variable declaration definition
	private WebElement SetupPageName = null;
	private WebElement SetupPageTitle = null;
	private WebElement DefineSetup_backBtn = null;
	private WebElement saveBtn = null;
	private WebElement SopProtocalTextBox =null;
	private WebElement 	NextButton=null;
	private WebElement createSetup=null;
	/*
	 * private WebElement DefineSetup_SetupName_txtBx = null; private WebElement
	 * DefineSetup_Sensordata_txtBx = null; private WebElement
	 * DefineSetup_AssetID_txtBx = null; private WebElement DefineSetup_SOP_txtBx =
	 * null; private WebElement DefineSetup_LoadDesc_txtBx = null; private
	 * WebElement DefineSetup_Cmnts_txtBx = null; private WebElement
	 * SensorConfiguration_Btn = null;
	 */
	private void initializeEelements() {
		SetupPageName = driver.findElementByAccessibilityId("TxtSetupCalibration");
		SetupPageTitle = driver.findElementByAccessibilityId("TxtSetupVerification");
		//DefineSetup_backBtn = driver.findElementByAccessibilityId("GoButton");
		 saveBtn = driver.findElementByAccessibilityId("SaveButton");
		 SopProtocalTextBox = driver.findElementByAccessibilityId("SopProtocalTextBox");
		 NextButton=driver.findElementByAccessibilityId("NextButton");//
		 createSetup=driver.findElementByAccessibilityId("AddSetPoint");
		 /*
		 * DefineSetup_SetupName_txtBx =
		 * driver.findElementByAccessibilityId("SetupNameTextBox");
		 * DefineSetup_Sensordata_txtBx =
		 * driver.findElementByAccessibilityId("PART_TextBox");
		 * DefineSetup_AssetID_txtBx =
		 * driver.findElementByAccessibilityId("VessalTextBox"); DefineSetup_SOP_txtBx =
		 * driver.findElementByAccessibilityId("SopProtocolTextBox");
		 * DefineSetup_LoadDesc_txtBx =
		 * driver.findElementByAccessibilityId("LoadDescTextBox");
		 * DefineSetup_Cmnts_txtBx =
		 * driver.findElementByAccessibilityId("CommentTextBox");
		 * SensorConfiguration_Btn = driver.findElementByAccessibilityId("NextButton");
		 */
	}

	setup_verificationpage() throws IOException {
		super();
		initializeEelements();
	}

	// Check the presence of Define Setup page
	public boolean SetupPage_state() {
		return IsElementVisibleStatus(SetupPageName);
	}

	// Get the Define Setup page Name text
	public String get_SetupPage_Nametext() {
		return FetchText(SetupPageName);
	}

	// Get the Define Setup page Title text
	public String get_defineSetupPage_Titletext() {
		return FetchText(SetupPageTitle);
	}

	// Click the Define Setup page Back button
	public void click_backBtn_Alert() throws InterruptedException {
	...
	// Clear Sensor count data
		...
		// Get the sensor text
					...
					public EquipmentHubPage ClickBackBtn() throws IOException, InterruptedException {
						WebElement bckbtn = driver.findElementByAccessibilityId("BackButton");
						clickOn(bckbtn);
						Thread.sleep(500);
					...
					public SelectBaseStationPage ClicknextBtn() throws IOException, InterruptedException {
						clickOn(NextButton);
					return new SelectBaseStationPage();
					}
					
					
					public  void CreateSetpoint() throws IOException, InterruptedException {
						clickOn(createSetup);
					}
					
					public  void CreateSetup() throws IOException, InterruptedException {
						WebElement CreateSetupButton = driver.findElementByAccessibilityId("CreateSetupButton");
						clickOn(CreateSetupButton);
					}
					
					
					
					public  void ChangesetpointSetup(String value) throws IOException, InterruptedException {
						WebElement SetupButton = driver.findElementByAccessibilityId("SetPointTextBox");
						clickOn(SetupButton);
						ClearText(SetupButton);
						enterText(SetupButton, value);
						clickOn(saveBtn);
					...
					public void ClicksaveBtn1() throws IOException, InterruptedException {
						clickOn(saveBtn);
						Thread.sleep(500);
					}
					
					
					public void EntersetupName(String Name) throws IOException, InterruptedException {
						WebElement SetupNameTextBox = driver.findElementByAccessibilityId("SetupNameTextBox");//SaveSetupPopup
						ClearText(SetupNameTextBox);
						enterText(SetupNameTextBox, Name);
					...
					public void PrintSetup() {
						WebElement PrintSetup=driver.findElementByAccessibilityId("PrintButton");
						clickOn(PrintSetup);
					}
